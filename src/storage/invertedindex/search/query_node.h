...
struct QueryNode {
    ...
    virtual std::shared_ptr<DocIterator>
...
struct TermQueryNode : public QueryNode {
    ...
    std::shared_ptr<DocIterator> CreateSearch(const TableEntry *table_entry, IndexReader &index_reader, EarlyTermAlgo early_term_algo) const override;
